...
SRCS = main.c libftTools/libfttools.c libftTools/tools.c get_next/get_next_line.c \
	...
	libftTools/ft_strtrim.c libftTools/libfttools2.c mandatory/src/parseMap2.c mandatory/src/moveUpDown.c mandatory/src/parseMap3.c\
...
BSRC = bonus/main_bonus.c libftTools/libfttools.c libftTools/tools.c get_next/get_next_line.c \
	...
	libftTools/ft_strtrim.c libftTools/libfttools2.c bonus/src_bonus/parsemap2_bonus.c bonus/src_bonus/draw_minimap.c  bonus/src_bonus/parseMap3_bonus.c bonus/src_bonus/moveUpDown_bonus.c\
