...
SRCS = main.c libftTools/libfttools.c libftTools/tools.c get_next/get_next_line.c \
	...
	mandatory/src/moveUpDown.c mandatory/src/parseMap3.c mandatory/src/rc_tools.c mandatory/src/check_line.c\
...
BSRC = bonus/main_bonus.c libftTools/libfttools.c libftTools/tools.c get_next/get_next_line.c \
	...
	bonus/src_bonus/rc_tools_bonus.c bonus/src_bonus/check_line_bonus.c\
